...
go_repository(
    ...
    sum = "h1:6m2YO+AmBApbUOmhsghW+IfRyZOY4My4UYvQQrEpHfY=",
    version = "v0.0.0-20200521211927-2b542361a4fc",
)
...
go_repository(
    ...
    sum = "h1:jAxmC8qqa7mW531FDgM8Ahbqlb3zmiHgTpJU6fY3vJ0=",
    version = "v1.19.45",
)
...
go_repository(
    ...
    sum = "h1:SQZ5w15wmZ2gSGxHnMj9n4OQyHjzTkSMtRfOAxvBMLU=",
    version = "v0.18.3",
)
